...
Save your time. This interview does not ask about it: segment tree, Fenwick tree, suffix structures, network flows, game theory (task 4 of the contest), hard DP over subsets, string algorithms at the level of KMP or Aho-Corasick.
